    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="p-6" x-data="{ step: {{ $otpValid ? 3 : ($otpSent ? 2 : 1) }} }">
            ...
            <div x-show="step === 1">
                ...
                <form method="POST" action="{{ route('talent.profile.request-otp') }}">
                    @csrf
                    <button type="submit"
            ...
            <div x-show="step === 2">
                ...
                <form method="POST" action="{{ route('talent.profile.verify-otp') }}" class="space-y-4">
                    @csrf
                    <div>
                ...
                <div class="mt-4 text-center">
                    <form method="POST" action="{{ route('talent.profile.request-otp') }}" class="inline">
                        @csrf
            ...
            <div x-show="step === 3">
                ...
                <form method="POST" action="{{ route('talent.profile.update-password') }}" class="space-y-4"
            ...
            <div class="mt-6 pt-4 border-t border-gray-100 text-center">
                <a href="{{ route('talent.profile.show') }}"
                   class="text-sm text-gray-400 hover:text-gray-600 transition-colors">
                    &larr; {{ __('common.back_to_profile') }}
                </a>
            </div>
        </div>
    </div>
