...
class SystemGuideController extends Controller
{
    private function modules(): array
    {
        return [
            ...
            ['key' => 'applicant_requests', 'name_key' => 'nav.applicant_requests', 'desc_key' => 'guide.desc_applicant_requests', 'route' => 'admin.applicant-requests.index', 'icon' => 'chat', 'category' => 'management', 'guide_ready' => true],
